...
%Tιμές των F, G για το configuration που επιλέξαμε
G = [25.5, -1.5, -11.8, -2.4, 36, -6.05, - 0.85]; %in DB
...
IP3 = [36.5, Inf, 11, Inf, 38.5,18, Inf];
...
%%Design 2 - Changing positions of amplifier and mixer (5) - (6)
