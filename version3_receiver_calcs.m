...
%%Design 3 - Variable amplifier in position (1)

%Calcs for 10 db gain
%System Configuration
clc;
clear;
var_gain = 10 %db, insert gain of variable ampl for which you calculate the params of the system
a2d_res = 12; 
a2d_maxv = 3.3;
BW = 10 * 10^6;
[Pinmin_a2d, Pinmax_a2d] = a2dpower(a2d_res, a2d_maxv);
%Tιμές των F, G για το νέο configuration που επιλέξαμε
G = [var_gain, -1.5, -11.8, -2.4, -6.05, 15 , - 0.85]; %in DB
NF = [2.4, 1.5 , 8 , 2.4 ,  6.05 , 4 , 0.85];%in dB
